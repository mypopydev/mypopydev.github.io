...
以前，要把这些乱局拆开理顺，往往是使用 Git 时最困难、也最耗时的部分。现在不一样了。编码智能体可以穿过那些极其绕的 merge conflicts，一边推断新代码原本的意图，一边判断哪些内容应该保留、冲突改动又应该怎样组合。如果你的代码有自动化测试——而且[它本来就应该有](https://simonwillison.net/guides/agentic-engineering-patterns/red-green-tdd/)——那智能体还可以在最终完成这次合并之前，确保测试全部通过。
